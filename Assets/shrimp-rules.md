...
- NEVER split existing manager files without explicit approval (GridManager.cs, PlayerManager.cs, etc.)
- NEVER introduce new singleton patterns without explicit approval
- NEVER modify core enumerations (Enumerations.cs) without explicit approval
- NEVER change Unity lifecycle patterns without explicit approval
- NEVER create new documentation without explicit approval
