...
public class TutorialMessageManager : MonoBehaviour, IMessageSystem, IManagerDebugInterface
{
    ...
    private PlayerCapabilities BuildPlayerCapabilities()
    {
        ...
        if (playerActionManager != null)
        {
            capabilities.CanUseUnitMarkers = playerActionManager.maxLightMarkerCharges > 0;
    ...
    private void UpdateContextData()
    {
        ...
        if (playerActionManager != null)
        {
            currentContext.availableMarkers = playerActionManager.maxRecursionMarkerCharges + playerActionManager.maxLightMarkerCharges + playerActionManager.maxPrimeMarkerCharges;
        }
