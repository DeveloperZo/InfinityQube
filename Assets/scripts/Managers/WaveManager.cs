...
CubeType cubeType = markerToCubeType[originalPos];
    ...
    /// Each marker type maps to a cube type: Light→Unit, Heavy→Recursion, Prime→Prime, Infinity→Infinity
    /// Positions are normalized to spawn at top of grid.
    /// </summary>
