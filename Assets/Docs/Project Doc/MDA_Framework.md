# MDA Framework Analysis - Infinity Cube

> Analyzing Infinity Cube through the Mechanics-Dynamics-Aesthetics framework to understand how mechanical systems create player experiences and emotional outcomes.

## Overview: The MDA Lens

**Mechanics** → **Dynamics** → **Aesthetics**
- **Mechanics**: The rules, systems, and interactions available to players
- **Dynamics**: The emergent behaviors and patterns that arise from mechanical interactions
- **Aesthetics**: The emotional responses and experiential outcomes players derive
